...
/**
 * CharFiller pertenece al grupo de las interfaces filler especialmente
 * pensadas para el llenado progresivo de cualquier tipo de colecciones de
 * caracteres incluidos los arreglos.
...
public interface CharFiller {
     ...
     */
    default void putAll(char... values) {
